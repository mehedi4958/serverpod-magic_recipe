    ...
    (unAuthSessionBuilder, endpoints) {
      ...
      test(
        ...
        await endpoints.recipes
            .deleteRecipe(sessionBuilder, recipeToDelete!.id!);
      ...
      test('when deleting a recipe users can only delete their own recipes',
        ...
        final recipeYouShouldNotDelete = await Recipe.db.findFirstRow(
          session,
        ...
        await expectException(
          () => endpoints.recipes
              .deleteRecipe(sessionBuilder, recipeYouShouldNotDelete!.id!),
          isA<Exception>(),
        );
      });
